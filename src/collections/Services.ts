...
/**
 * The eight services from brief section 4, plus trade-fair accompaniment, which
 * the brief flags as worth adding. Each is one document with both locales on
 * it — Payload's own localisation, not two parallel trees — so an editor
 * translates in place and the slug stays shared between /services/x and
 * /en/services/x.
 */
